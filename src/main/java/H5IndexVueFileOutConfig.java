 ...
 * @since:
 **/
public class H5IndexVueFileOutConfig extends FileOutConfig {
    ...
    public String outputFile(Map<String, String> pathInfo, TableInfo tableInfo) {
        ...
        if (null != pathInfo.get(ConstVal.SERVICE_PATH)) {
            ...
            String file = String.format(h5Path(servicePath) + "%sIndex.vue",StringUtils.uncapitalize(entityName));
            return file;
        }
        return null;
    }
    ...
    public String getTemplatePath() {
        return "templates/index.vue.ftl";
    }
